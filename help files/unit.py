...
class BaseUnit(ABC):
    ...
    def health_points(self):
        return round(self.hp, 2)  # TODO возвращаем аттрибут hp в красивом виде для фронта

    @property
    def stamina_points(self):
        return round(self.stamina, 2)  # TODO возвращаем аттрибут stamina в красивом виде для фронта
